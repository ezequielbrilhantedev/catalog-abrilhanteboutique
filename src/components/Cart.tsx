    ...
    <>
      ...
      >
        <div className="flex items-center justify-between border-b border-soft p-6">
          <h2 className="bb-eyebrow text-sm">
            Meu carrinho
          </h2>
          <IconButton
            variant="ghost"
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-2 flex items-center gap-3">
                    <div
                      className="flex items-center gap-3 rounded-pill border border-soft"
                    ...
                    >
                      ...
                      <span className="w-4 text-center font-sans text-sm text-strong">
                        {item.quantity}
                      </span>
                      <button
                        onClick={() =>
        ...
        {items.length > 0 && (
          <div className="flex flex-col gap-4 border-t border-soft p-6">
            <div className="flex items-baseline justify-between">
              <span
                className="font-engrave text-xs uppercase text-muted"
