    ...
    <div>
      {showHero && (
        <section className="mx-auto max-w-container px-6 pb-10 pt-16 text-center">
          <div className="bb-eyebrow mb-3 text-xs">
            Semijoias &amp; Folheados
          </div>
          <h1
            className="mx-auto max-w-2xl"
            style={{ fontSize: '4rem', lineHeight: 1.02 }}
          >
          ...
          <p className="mx-auto mt-4 max-w-lg font-sans text-lg leading-relaxed text-muted">
            Encontre o acessório que combina com você.
            Escolha suas peças e finalize pelo WhatsApp
          </p>
          <div
            className="bb-rule mx-auto mt-6"
            style={{ maxWidth: 120 }}
          />
        </section>
      )}
      ...
      <section
        className="mx-auto max-w-container px-6 pb-16"
        style={{ paddingTop: showHero ? 0 : '2.5rem' }}
      >
        ...
        {error && (
          <p className="mt-12 text-center font-sans text-danger">
            Erro ao carregar produtos. Tente novamente.
          </p>
        )}

        {!isLoading && !error && filtered.length === 0 && (
          <p className="mt-12 text-center font-sans text-faint">
